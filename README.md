# BBoPSoundAnalysis <img src="man/figures/logo.png" align="right" width="120" />

<!-- badges: start -->
<!-- Add badges from GitHub Actions, CRAN status, Codecov, etc. -->
<!-- badges: end -->
...
**CreateManifes**t: create a manifest of sound files
